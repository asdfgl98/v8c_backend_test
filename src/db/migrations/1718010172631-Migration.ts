...
export class Migration1718010172631 implements MigrationInterface {
    name = 'Migration1718010172631'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`TB_POST\` ADD \`deletedAt\` datetime(6) NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`TB_IMAGE_URL\` DROP COLUMN \`url\``);
        await queryRunner.query(`ALTER TABLE \`TB_IMAGE_URL\` ADD \`url\` varchar(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`TB_POST\` DROP COLUMN \`deletedAt\``);
        ...
        await queryRunner.query(`ALTER TABLE \`TB_IMAGE_URL\` ADD CONSTRAINT \`FK_277a47c70f119fea2aea12252fd\` FOREIGN KEY (\`postId\`) REFERENCES \`v8cdb\`.\`TB_POST\`(\`postId\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
