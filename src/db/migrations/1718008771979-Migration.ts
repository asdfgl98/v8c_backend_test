...
export class Migration1718008771979 implements MigrationInterface {
    name = 'Migration1718008771979'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP INDEX \`FK_277a47c70f119fea2aea12252fd\` ON \`TB_IMAGE_URL\``);
        await queryRunner.query(`DROP INDEX \`FK_1ded90a4a017f8818f19276d67d\` ON \`TB_COMMENT\``);
        await queryRunner.query(`DROP INDEX \`FK_48562e9a8de6e19439e59e94ed9\` ON \`TB_COMMENT\``);
        await queryRunner.query(`DROP INDEX \`FK_c48a607c0ab956dfb53e30eef42\` ON \`TB_COMMENT\``);
        await queryRunner.query(`DROP INDEX \`FK_69804818428bb1a51e53fd0cea5\` ON \`TB_POST\``);
        ...
        await queryRunner.query(`ALTER TABLE \`TB_IMAGE_URL\` ADD CONSTRAINT \`FK_277a47c70f119fea2aea12252fd\` FOREIGN KEY (\`postId\`) REFERENCES \`TB_POST\`(\`postId\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE INDEX \`FK_69804818428bb1a51e53fd0cea5\` ON \`TB_POST\` (\`userId\`)`);
        await queryRunner.query(`CREATE INDEX \`FK_c48a607c0ab956dfb53e30eef42\` ON \`TB_COMMENT\` (\`userId\`)`);
        await queryRunner.query(`CREATE INDEX \`FK_48562e9a8de6e19439e59e94ed9\` ON \`TB_COMMENT\` (\`parentCommentId\`)`);
        await queryRunner.query(`CREATE INDEX \`FK_1ded90a4a017f8818f19276d67d\` ON \`TB_COMMENT\` (\`postId\`)`);
        await queryRunner.query(`CREATE INDEX \`FK_277a47c70f119fea2aea12252fd\` ON \`TB_IMAGE_URL\` (\`postId\`)`);
    }
